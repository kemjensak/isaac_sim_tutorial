...
- *Add Pose*를 누른 후*Pose Name*을 `up`으로, *Planning Group*을 `manipulator`로 설정한  후, `shoulder_lift_joint` 값을 `-1.5708`로 변경하고, 나머지 모든 joint 값이 0임을 확인하고 *Save*를 누른다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI1NzY3ODE1Niw2Mzk2NDU5NTksMjE4Mz
